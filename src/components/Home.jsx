    ...
    <>
      ...
      >
        <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row items-center justify-between h-full px-4">
          ...
          {/* Left: Text */}
          <div className="flex flex-col justify-center h-full md:w-1/2 relative">
            <h2 className="text-4xl sm:text-7xl font-bold text-white animate-slide-in">
              I'm a{" "}
            ...
            <p className="text-gray-500 py-4 max-w-md text-justify animate-fade-in">
      ...
      <style jsx>{`
        ...
        .animate-bounce-in {
          animation: bounce-in 1.2s ease-in-out forwards;
        }
      `}</style>
    </>
  );
